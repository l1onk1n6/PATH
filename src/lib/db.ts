...
export async function upsertResume(resume: Resume): Promise<void> {
  ...
  try {
    ...
    await sb().from('resumes').upsert({
      ...
      personal_info: resume.personalInfo as unknown as import('../types/supabase').Json,
      cover_letter: resume.coverLetter as unknown as import('../types/supabase').Json,
      work_experience: resume.workExperience as unknown as import('../types/supabase').Json,
      education: resume.education as unknown as import('../types/supabase').Json,
      skills: resume.skills as unknown as import('../types/supabase').Json,
      languages: resume.languages as unknown as import('../types/supabase').Json,
      projects: resume.projects as unknown as import('../types/supabase').Json,
      certificates: resume.certificates as unknown as import('../types/supabase').Json,
      custom_sections: (resume.customSections ?? []) as unknown as import('../types/supabase').Json,

...
const TRANSLATIONS: Record<Locale, Record<string, string>> = {
  ...
  en: {
    ...
    'Geschenkt': 'Gift',
    'Verlängert am {date}': 'Renews on {date}',
    'Upgrade': 'Upgrade',
    '5 Personen & 60 Mappen': '5 people & 60 applications',
    'Alle Templates': 'All templates',
    'Unbegrenzte PDF-Exports': 'Unlimited PDF exports',
    '2 MB Foto-Upload': '2 MB photo upload',
    'KI-Assistent': 'AI assistant',
    'Link-Analytics': 'Link analytics',
    'Mehrsprachige CVs': 'Multilingual resumes',
    'PDF-Passwortschutz': 'PDF password protection',
    ...
    'Aktionen': 'Actions',
    'Status: {status} – klicken zum Ändern': 'Status: {status} – click to change',
    'Mappe': 'Application',
    ...
    'APP-TOUR': 'APP TOUR',
    'Zeige die Einführungstour erneut an.': 'Show the intro tour again.',
    'Teile deinen persönlichen Link. Wenn sich jemand über deinen Link registriert und ein Pro-Abo abschliesst, bekommst du automatisch CHF 5.00 auf dein Konto gutgeschrieben.':
      'Share your personal link. When someone signs up through your link and subscribes to Pro, you automatically get CHF 5.00 credited to your account.',
    'SUPPORT': 'SUPPORT',
    'SITZUNG': 'SESSION',
    'PASSWORT': 'PASSWORD',
    ...
    'Vorlagen': 'Templates',
    'Stellenausschreibung URL': 'Job posting URL',
    'Bewerbungsfrist': 'Application deadline',
    'E-Mail-Reminder vor Frist': 'Email reminder before deadline',
    'Zuerst eine Bewerbungsfrist setzen.': 'First set an application deadline.',
    'KI-Assistent — Anschreiben generieren': 'AI assistant — generate cover letter',
    'Der bestehende Anschreiben-Text wird überschrieben.': 'The existing cover letter text will be overwritten.',
    'Stellenbeschreibung (optional, für bessere Ergebnisse)': 'Job description (optional, for better results)',
    ...
    'Einträge': 'Entries',
    'nach Datum': 'by date',
    'Aktuell tätig': 'Currently active',
    'Eintrag {n}': 'Entry {n}',
    'Tipp: Einfach tippen — pro Zeile ein Punkt. Bullets fügt das System automatisch ein.':
      'Tip: Just type — one point per line. The system adds bullets automatically.',
    'Pro Zeile ein Stichpunkt — System formatiert als Aufzählung:\nEntwicklung und Betreuung von Microsoft-Power-Platform-Lösungen\nKonzeption von M365-Teams-Strukturen\nLeitung IT-Projekte':
      'One bullet per line — the system formats it as a list:\nDevelopment and support of Microsoft Power Platform solutions\nDesign of M365 Teams structures\nLeading IT projects',
    'Pro Zeile ein Stichpunkt:\nSchwerpunkt Software Engineering\nAbschlussarbeit "Skalierbare Microservices"\nAustauschsemester in Kopenhagen':
      'One bullet per line:\nFocus on software engineering\nThesis "Scalable Microservices"\nExchange semester in Copenhagen',
    'Skills': 'Skills',

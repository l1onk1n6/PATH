/**
 * Temporary page for automated screenshot capture — not linked in nav.
 * Renders a resume template with sample data at A4 size.
 * Visit: /#/screenshot?t=minimal&accent=%23007AFF
 */
...
export default function ScreenshotPage() {
  ...
  const resume: Resume = { ...SAMPLE, templateId, accentColor: accent };

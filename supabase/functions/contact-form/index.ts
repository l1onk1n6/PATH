  ...
  <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background:#0a0a0a;padding:48px 16px;">
    <tr><td align="center">
      <table width="540" cellpadding="0" cellspacing="0" border="0" style="max-width:540px;width:100%;">
              ...
              <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                <defs>
                  <linearGradient id="em-bg" x1="0" y1="0" x2="36" y2="36" gradientUnits="userSpaceOnUse">
                    <stop offset="0%" stop-color="#34C759"/><stop offset="100%" stop-color="#00C7BE"/>
                  </linearGradient>
                  ...
                  <clipPath id="em-clip"><rect width="36" height="36" rx="9"/></clipPath>
                </defs>
        ...
        <!-- Card -->
        <tr><td style="background:#161616;border:1px solid #2a2a2a;border-radius:16px;padding:40px 44px 36px;">

          <!-- Icon -->
          <div align="center" style="margin-bottom:24px;">
            <div style="display:inline-block;width:60px;height:60px;border-radius:50%;background:#1a1a2a;border:1px solid #2a2a4a;text-align:center;line-height:58px;font-size:26px;">✉️</div>
          </div>
          ...
          <!-- Body -->
          <p style="margin:0 0 20px;font-size:15px;color:#aaa;line-height:1.65;">
            Hallo ${safeName},
          </p>
          ...
          <!-- Message quote -->
          <div style="background:#1e1e1e;border:1px solid #2a2a2a;border-left:3px solid #34C759;border-radius:8px;padding:16px 18px;margin-bottom:8px;">
            <p style="margin:0 0 6px;font-size:11px;font-weight:600;color:#555;letter-spacing:0.06em;text-transform:uppercase;">Deine Nachricht</p>
            <p style="margin:0;font-size:14px;color:#888;line-height:1.6;">${safeMessage}</p>
          </div>
        ...
        <tr><td style="padding:20px 0 0;text-align:center;">
          <p style="margin:0 0 4px;font-size:12px;color:#444;">PATH &mdash; Dein professioneller Bewerbungsmanager</p>
